...
En esta sección se especifican los aspectos principales del Sprint Planning Meeting para el Sprint 3. Este encuentro fue clave para definir el cierre del proyecto, priorizando la integración completa de los componentes IoT (Edge y dispositivo embebido) con la Web Application y la Mobile App, así como el despliegue final de todos los artefactos en producción.
...
| Prepared by                        | Valentino Cervantes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Attendees (to planning meeting)    | Valentino Cervantes, Miguel Carpio, Mathias Vasquez, Gabriel Braithuaite, Sihuar Ccotarma                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Sprint n - 1 Review  Summary       | En el Sprint 2 se completó la integración de la autenticación (sign-in, auth-me, manejo de cookies), la gestión básica de hoteles y habitaciones, la pantalla web de reservas por hotel y la primera versión funcional de la app móvil para solicitar servicios a la habitación, todo conectado al backend desplegado en Coolify. La plataforma ya permite a administradores gestionar el inventario principal y a los huéspedes interactuar con el hotel desde el móvil.                                                                                                                                                                                                                                                              |
| Sprint n - 1 Retrospective Summary | En la retrospectiva del Sprint 2 se identificó la necesidad de: (a) mejorar la trazabilidad de los eventos entre backend, web, mobile e IoT; (b) centralizar la configuración de entornos (URLs de API y brokers); y (c) reforzar las pruebas end-to-end antes de desplegar. Para Sprint 3 se acordó priorizar la integración IoT extremo a extremo (embeded–Edge–API–web–mobile), documentar los flujos críticos y automatizar, en lo posible, los procesos de despliegue.                                                                                                                                                                                                                                                           |
| **Sprint Goal & User Stories**     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Sprint 3 Goal                      | Nuestro foco en el Sprint 3 es entregar la **versión integrada y final del ecosistema Dedalus**, completando todas las User Stories del Product Backlog. Esto incluye: la conexión estable entre el dispositivo embebido y el Edge mediante MQTT local, el control de servos y LEDs desde la Web Application y la Mobile App, el dashboard IoT con lectura en tiempo real de sensores, la gestión de pedidos de huéspedes desde el panel de staff y el despliegue consolidado de backend, front-end web, landing page y app móvil, listos para su demostración en el curso de IoT.                                                                                                                             |
...
En esta sección se asignan responsables y colaboradores para los aspectos clave del Sprint 3, asegurando la integración completa entre backend, front-end, mobile y componentes IoT (Edge y dispositivo embebido).

| **Aspecto**                 | **Leader**          | **Collaborators**                                          | **Responsabilidad principal en el Sprint 3**                                                                                  |
|----------------------------|---------------------|------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| Backend & API              | Mathias Vasquez     | Valentino Cervantes, Miguel Carpio                        | Exponer y ajustar endpoints necesarios para IoT (dashboard, control de actuadores, pedidos de huéspedes) y soporte mobile.   |
| Web Application (Admin/Staff) | Miguel Carpio       | Gabriel Braithuaite, Sihuar Ccotarma                       | Finalizar pantallas de dashboard IoT, gestión de pedidos de huéspedes y ajustes de reservas/rooms integrados al backend.     |
| Mobile App (Guest)         | Gabriel Braithuaite | Valentino Cervantes, Sihuar Ccotarma                      | Completar flujos móviles de servicio a la habitación, llave NFC y visualización básica de estado IoT relacionado al huésped. |
| Edge & Embedded (IoT)      | Sihuar Ccotarma     | Mathias Vasquez, Miguel Carpio                             | Configurar MQTT local, conectar el prototipo embebido, exponer endpoints del Edge y probar control de servos y LEDs.         |
| Deploy & Infra (Coolify)   | Valentino Cervantes | Mathias Vasquez                                            | Coordinar despliegues de backend, front-end, landing y servicios IoT, validando que todos los entornos apunten a producción. |
| QA & Documentation         | Todo el equipo      | —                                                          | Diseñar y ejecutar pruebas end-to-end y documentar evidencias para la revisión y demo final del curso.                       |


### 6.2.3.3 Sprint Backlog 3

En esta sección se presenta el Sprint Backlog del Sprint 3, que incluye las tareas orientadas a completar las User Stories restantes del Product Backlog, con especial énfasis en la capa IoT (Edge + embebido) y en el despliegue final de todo el ecosistema.

| Sprint # | User Story Id | Title                                         | Work Item Id | Task Title                                                    | Description                                                                                                                                                                                                                                  | Estimation (Hours) | Assigned To | Status   |
|---------:|---------------|-----------------------------------------------|--------------|---------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------:|-------------|----------|
| Sprint 3 | US016         | Dashboard IoT                                 | WI16         | Implementar vista de dashboard IoT en web                     | Crear la pantalla de dashboard IoT en la Web Application que consuma los datos del Edge (sensores y estado de actuadores) y los muestre en tarjetas/gráficas simples para el administrador del hotel.                                       | 3.5               | Miguel      | In Progress |
| Sprint 3 | US016         | Dashboard IoT                                 | WI16A        | Integrar dashboard con API/Edge                               | Conectar la vista de dashboard IoT con los endpoints del backend/Edge, manejando actualización periódica de datos y mensajes de error cuando el broker o el Edge no estén disponibles.                                                      | 3.0               | Mathias     | To Do    |
| Sprint 3 | US017         | Gestión de pedidos de huéspedes (staff web)   | WI17         | Mejorar pantalla de pedidos para staff                        | Completar la pantalla web donde el staff visualiza y filtra los pedidos de servicio a la habitación generados desde la app móvil, mostrando estado, habitación y huésped.                                                                   | 2.5               | Miguel      | In Progress |
| Sprint 3 | US017         | Gestión de pedidos de huéspedes (staff web)   | WI17A        | Actualización de estado y trazabilidad de pedidos             | Implementar acciones para cambiar el estado de los pedidos (pendiente, en progreso, atendido) y registrar la fecha de atención, manteniendo la trazabilidad en el backend.                                                                 | 3.0               | Sihuar      | To Do    |
| Sprint 3 | US019         | App móvil – Emisión de llave NFC              | WI18         | Implementar lectura de llave NFC desde guest profile          | Integrar en la app móvil la obtención de la llave del huésped desde el backend (guest profile) y preparar el payload para la emisión NFC.                                                                                                   | 3.0               | Gabriel     | In Progress |
| Sprint 3 | US019         | App móvil – Emisión de llave NFC              | WI18A        | Programar emisión NFC y manejo de errores                     | Programar la emisión NFC en el dispositivo móvil, mostrando feedback al usuario (éxito / fallo) y controlando el caso donde el huésped no tenga llave configurada.                                                                          | 3.0               | Gabriel     | To Do    |
| Sprint 3 | US020         | Integración Edge–Embedded                      | WI19         | Configurar broker MQTT local y tópicos                        | Configurar el broker MQTT local en el Edge, definir los tópicos de comunicación con el dispositivo embebido y probar la publicación/suscripción básica de mensajes.                                                                         | 4.0               | Sihuar      | In Progress |
| Sprint 3 | US020         | Integración Edge–Embedded                      | WI19A        | Conectar prototipo embebido y probar sensores                 | Conectar el prototipo físico (sensores y actuadores) al Edge, probar lectura de sensores y envío de datos hacia la API para que puedan ser visualizados en el dashboard IoT.                                                                | 4.0               | Sihuar      | To Do    |
| Sprint 3 | US020         | Integración Edge–Embedded                      | WI19B        | Control de servos y LEDs desde web/móvil                      | Implementar la ruta completa para controlar servos y LEDs desde la Web Application y, cuando aplique, desde la app móvil, verificando que las órdenes lleguen al Edge y se reflejen en el prototipo embebido.                              | 4.0               | Mathias     | To Do    |
| Sprint 3 | US008         | Uso de tarjeta física / credencial alternativa | WI20         | Definir flujo de credenciales físicas en el sistema           | Documentar y configurar, a nivel de backend y web, el manejo de códigos/credenciales físicas como alternativa a NFC, asegurando que queden registradas en el historial de accesos.                                                          | 2.0               | Valentino   | In Progress |
| Sprint 3 | US009         | Revocación de acceso en checkout              | WI20A        | Ajustar lógica de revocación de credenciales                  | Implementar la lógica que, al registrar un checkout, invalida credenciales digitales (NFC y cuentas activas) y deja trazado el evento en el historial de accesos.                                                                          | 3.0               | Mathias     | To Do    |
| Sprint 3 | US010         | Registro de accesos                            | WI21         | Completar filtros y exportación de historial                  | Extender la pantalla de registro de accesos para permitir filtros avanzados (fecha, habitación, método) y la exportación de los resultados visibles a CSV.                                                                                | 2.5               | Sihuar      | In Progress |
| Sprint 3 | US012         | Gestión de clases de habitación                | WI21A        | UI y lógica final de room classes                             | Ajustar la interfaz y lógica de creación/edición de clases de habitación, garantizando su integración con la creación de rooms y la consulta por hotelId.                                                                                | 3.0               | Miguel      | To Do    |
| Sprint 3 | US014         | Gestión de reservas (Bookings API avanzada)    | WI22         | Validaciones finales de reservas y conflictos de horario      | Implementar validaciones adicionales en el backend para evitar solapamientos de reservas y mejorar los mensajes de error devueltos a la web application.                                                                                  | 3.5               | Mathias     | In Progress |
| Sprint 3 | US001–US005   | Cierre funcional de Landing y despliegues      | WI23         | Ajustes finales y verificación de despliegue web/landing      | Realizar pequeños ajustes de contenido/estilo en la landing y verificar que tanto la landing como la Web Application estén correctamente desplegadas y apuntando a la API de producción.                                                  | 2.5               | Valentino   | In Progress |
